...
def parse_pcap(pcapfile):
    """Collect request and response HTTP sessions for a tuple and invoke
    function to extract relevant meta data.

    Args:
        userid (str)        : User ID
        pcapfilename (str)  : Name of the PCAP file to build the sessions
                              from.

    Returns:
        list: List of docs with same format as extracted from Page events
    """
